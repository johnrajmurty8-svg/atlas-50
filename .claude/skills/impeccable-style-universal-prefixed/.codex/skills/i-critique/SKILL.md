...
Invoke $i-impeccable, which contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding. If no design context exists yet, you MUST run $i-impeccable teach first. Additionally gather: what the interface is trying to accomplish.
...
- **Suggested command**: Which command could address this (from: $i-polish, $i-typeset, $i-colorize, $i-quieter, $i-critique, $i-overdrive, $i-clarify, $i-bolder, $i-audit, $i-distill, $i-harden, $i-layout, $i-shape, $i-animate, $i-optimize, $i-adapt, $i-delight)
...
- Only recommend commands from: $i-polish, $i-typeset, $i-colorize, $i-quieter, $i-critique, $i-overdrive, $i-clarify, $i-bolder, $i-audit, $i-distill, $i-harden, $i-layout, $i-shape, $i-animate, $i-optimize, $i-adapt, $i-delight
