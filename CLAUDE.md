...
> Generated by `/i-impeccable teach` on 2026-04-20. Full version in `.impeccable.md`.

### Brand Personality

**Wandering · Sensory · Alive**

- *Wandering*: purposefully aimless — the globe invites drift, there's no funnel or conversion goal
- *Sensory*: the interface has texture; cream on deep navy, the weight of large serif type, the glow of hotspots
- *Alive*: the globe rotates unprompted, hotspots pulse, the Moodboard breathes with parallax

### Emotional Arc

**Beauty → Scale → Conviction** — in that order. Users should feel "that was beautiful" within 10 seconds, grow a sense of the world's scale as they browse, and leave with 1–2 destinations burning in their mind ("I have to go there").

### Anti-Reference

**TripAdvisor / Booking.com** — ratings-driven, transactional, cluttered with CTAs, optimised for conversion. If a design decision makes Atlas /50 feel more like a booking tool, reverse it. Also avoid: glassmorphism as decoration, gradient text, rounded cards with drop shadows, generic SaaS aesthetic.

### Design Principles

1. **The globe is the hero.** Panels float over it; they don't compete with it.
2. **Restraint in decoration, specificity in detail.** No flourishes beyond the prototype — but every detail that IS there must be precise.
3. **Editorial voice, not UI voice.** "Fifty places, this season." not "View all destinations."
4. **Permanence over responsiveness.** Desktop-only V1. Absolute positioning. No unspecified flexibility.
5. **Dark by nature, warm by detail.** `#050912` background, but cream tones and `#ffd100` accent keep it warm, never clinical.
